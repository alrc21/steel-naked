...
export const lineReveal: Variants = {
  ...
  visible: {
    y: '0%',
    transition: { duration: 0.8, ease: EASE_EDITORIAL as unknown as [number, number, number, number] },
  },
};

export const eyebrowSlide: Variants = {
  hidden: { opacity: 0, x: -20 },
  visible: {
    opacity: 1,
    x: 0,
    transition: { duration: 0.7, ease: EASE_EDITORIAL as unknown as [number, number, number, number] },
  },
};
